...
#import "HXCacheFileDefine.h"

@interface HXCacheFileManager : NSObject
 ...
 *  @param filePath 文件路径
 *
 *  @return HXCacheFileType
 */
+ (HXCacheFileType)fileTypeReadWithFilePath:(NSString *)filePath;
